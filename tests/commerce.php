...
$payment=(string)@file_get_contents($root.'/app/Controllers/PaymentController.php');foreach(['OrderService::cancel','payment_status','provider_token'] as $needle){if(!str_contains($payment,$needle))$fail[]='Ödeme hata/tekrar koruması eksik: '.$needle;}
