...
final class AdminView
{
    ...
    {
        self::requireUser();$a=Security::escape((string)App::config('app.admin_path','yonetim'));echo '<!doctype html><html lang="tr"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>'.Security::escape($title).'</title><link rel="stylesheet" href="/assets/css/admin.css"><body><div class="admin"><nav class="sidebar"><strong>Arcates</strong><a href="/'.$a.'">Panel</a><a href="/'.$a.'/sayfalar">Sayfalar</a><a href="/'.$a.'/menuler">Menüler</a><a href="/'.$a.'/medya">Medya</a><a href="/'.$a.'/formlar">Formlar</a><a href="/'.$a.'/portfoy">Portföy</a><a href="/'.$a.'/blog">Blog</a><a href="/'.$a.'/referanslar">Referanslar</a></nav><main class="main"><h1>'.Security::escape($title).'</h1>';
    }
