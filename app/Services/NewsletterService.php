...
final class NewsletterService
{
    ...
    private function signature(int $id,string $email): string{return hash_hmac('sha256',$id.'|'.strtolower($email),$this->requireSecret());}
    private function requireSecret(): string{$secret=(string)App::config('newsletter.secret','');if(strlen($secret)<32)throw new \RuntimeException('newsletter.secret en az 32 karakter olmalı.');return $secret;}
}
