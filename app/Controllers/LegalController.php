...
final class LegalController
{
 ...
 public function distanceSales(): void{$this->page('Mesafeli Satış Sözleşmesi Şablonu','Bu sayfa müşteri projesinde satıcı unvanı, adresi, MERSİS/vergi bilgileri, ürün, fiyat, teslimat, cayma hakkı ve uyuşmazlık bilgileri doldurularak hukuk danışmanı tarafından doğrulanmalıdır. Arcates Core örnek şablon sağlar; satıcıya özel hukuki bilgi üretmez.');}
 public function returns(): void{$this->page('İade ve Cayma Koşulları Şablonu','Teslimat, cayma süresi, iade yöntemi, istisnalar ve geri ödeme süresi müşteri işletmesinin gerçek koşullarına göre doldurulmalı ve yürürlükteki mevzuata uygunluğu hukuk danışmanıyla doğrulanmalıdır.');}
